...
**dmft** implements GBD-style Bayesian hierarchical models for
...
- **Bayesian spatial-temporal-age modeling** with BYM2 spatial effects,
  RW2 temporal trends, and RW1 age effects
- **Two inference backends**: INLA (fast approximate Bayesian) and Stan
  (full MCMC via cmdstanr)
- **Gaussian meta-regression** with inverse-variance weighting for
  study-level summary data
